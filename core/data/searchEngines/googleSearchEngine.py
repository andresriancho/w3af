...
class GAjaxSearch(GoogleAPISearch):
    ...
    def _do_google_search(self):
        ...
        while start < max_start:
            ...
            # Do the request
            try:
                resp = self._do_GET(self.GOOGLE_AJAX_SEARCH_URL + params)
            except:
    ...
    def _extract_links(self, pages):
        ...
        for page in pages:
            ...
            links += [googleResult(res['url']) for res in \
...
class GStandardSearch(GoogleAPISearch):
    ...
    def _do_google_search(self):
        ...
        while start < max_start  and there_is_more:
            ...
            response = self._do_GET(self.GOOGLE_SEARCH_URL + params)
