{'LEXICAL': {'200': 'OK',
             ...
             'SERVER_NAME': 'Apache/1.3.26_3 (FreeBSD 4.6.2-RELEASE)'},
 'SEMANTIC': {'LARGE_HEADER_RANGES': [(1, '200'),
              ...
              'MANY_HEADER_RANGES': [(1, '200'),
                                     ...
                                     (100, '400'),
                                     (10000, '400')]},
 'SYNTACTIC': {'ALLOW_ORDER': 'GET, HEAD, POST, PUT, DELETE, CONNECT, OPTIONS, PATCH, PROPFIND, PROPPATCH, MKCOL, COPY, MOVE, LOCK, UNLOCK, TRACE',
               'ETag': '"7b890-263-3c59c9ae"',
               'HEADER_ORDER': [['Date',
                                 'Server',
                                 'Content-Length',
                                 'Allow',
