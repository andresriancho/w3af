...
VULNS = {
         ...
         'Insecure file upload': None,
         'Format string vulnerability': None,
         'Insecure Frontpage extensions configuration': None,
         ...
         'Persistent Cross-Site Scripting vulnerability': None,
         'Cross site scripting vulnerability': 62,
         'Cross site tracing vulnerability': 63,
         'Parameter modifies response headers': None,
         'eval() input injection vulnerability': 6,
         'Reflected File Download vulnerability': None,
         'Shell shock vulnerability': None,
         ...
         'Code disclosure vulnerability in 404 page': None,
         'Unhandled error in web application': None,
         ...
         'Missing cache control for HTTPS content': None,
         ...
         'Descriptive error page': None,
         'Error page with information disclosure': None,
         'Oracle application server': None,
         'Strange header': None,
         ...
         'Information disclosure via .NET errors': None,
