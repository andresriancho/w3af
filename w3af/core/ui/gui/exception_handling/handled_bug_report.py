...
from w3af.core.ui.gui.exception_handling.common_windows import (simple_base_window,
                                                           github_multi_bug_report)
...
class bug_report_window(simple_base_window, github_multi_bug_report):
    ...
    def __init__(self, w3af_core, title):
        ...
        github_multi_bug_report.__init__(self, exception_list, scan_id)
    ...
    def report_bug(self, widg):
        ...
        # Report the bug
        github_multi_bug_report.report_bug(self)
