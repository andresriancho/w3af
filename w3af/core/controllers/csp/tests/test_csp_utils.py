...
class TestUtils(unittest.TestCase):
    ...
    def test_find_vulns_case01(self):
        ...
        self.assertTrue(
            self._vuln_exists(
                "Directive 'style-src' allows all CSS sources.",
                vulns[CSP_DIRECTIVE_STYLE]))
        #>>>"img-src"
        self.assertEqual(len(vulns[CSP_DIRECTIVE_IMAGE]), 1)
        self.assertTrue(
            self._vuln_exists(
                "Directive 'img-src' allows all image sources.",
        ...
        self.assertTrue(
            self._vuln_exists(
                "Directive 'frame-src' allows all sources.",
        ...
        self.assertTrue(
            self._vuln_exists(
                "Directive 'plugin-types' allows all plugins types.",
