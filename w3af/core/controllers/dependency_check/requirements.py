...
PHPLY_GIT = 'git+https://github.com/ramen/phply.git#egg=phply'


PIP_PACKAGES = [PIPDependency('clamd', 'clamd', '1.0.1'),
                PIPDependency('github', 'PyGithub', '1.10.0'),
                PIPDependency('git.util', 'GitPython', '0.3.2.RC1'),
                PIPDependency('pybloomfilter', 'pybloomfiltermmap', '0.3.10'),
                PIPDependency('esmre', 'esmre', '0.3.1'),
                PIPDependency('phply', PHPLY_GIT, 'dev', is_git=True),
                PIPDependency('sqlite3', 'pysqlite', '2.6.3'),
                PIPDependency('nltk', 'nltk', '2.0b9'),
                PIPDependency('chardet', 'chardet', '2.0.1'),
                PIPDependency('pdfminer', 'pdfminer', '20110515'),
                PIPDependency('concurrent.futures', 'futures', '2.1.3'),
                PIPDependency('OpenSSL', 'pyOpenSSL', '0.12'),
