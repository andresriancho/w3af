...
class AngularBasicTest(BaseChromeCrawlerTest):
    ...
    def test_angular_two_button_click(self):
        self._unittest_setup(AngularTwoButtonClickRequestHandler)
        self._crawl(self.url.url_string)
...
class AngularTwoButtonClickRequestHandler(ExtendedHttpRequestHandler):
