...
class ChromeCrawler(object):
    ...
    def crawl(self, url, http_traffic_queue, debug=False):
        ...
        :param debug: When debug is set to True extra debugging information is
                      printed to the output log.
        ...
        took_line = TookLine('Spent %.2f seconds loading URL in chrome', debug)
        ...
        took_line = TookLine('Spent %.2f seconds in chrome.stop()', debug)
        ...
        #
        took_line = TookLine('Spent %.2f seconds parsing the DOM', debug)
        ...
        #
        took_line = TookLine('Spent %.2f seconds crawling using JS events', debug)
        ...
        #
        took_line = TookLine('Spent %.2f seconds cleaning up', debug)
