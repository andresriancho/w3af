...
class TestChangeLog(unittest.TestCase):
    ...
    def test_changes_between(self):
        ...
        self.assertEqual(first_commit.changes,
                         [('D',
                           'core/controllers/tests/pylint_plugins/pysvn_fix.py'),
                          ('M',
                           'core/controllers/tests/pylint.rc')])
    ...
    def test_str(self):
        ...
        self.assertTrue(changelog_str.startswith(
            '9c5f561441: Removing pysvn fixes for'))
