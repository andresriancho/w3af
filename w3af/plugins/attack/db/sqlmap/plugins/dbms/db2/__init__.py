...
from w3af.plugins.dbms.db2.enumeration import Enumeration
from w3af.plugins.dbms.db2.filesystem import Filesystem
from w3af.plugins.dbms.db2.fingerprint import Fingerprint
from w3af.plugins.dbms.db2.syntax import Syntax
from w3af.plugins.dbms.db2.takeover import Takeover
