...
def main():
    ...
    if decode == None:
        ...
        try:
            om.out.information( base64.b64decode( decode) )
        except:
            om.out.information( 'Could not decode string.' )
