...
class test_strange_parameters(unittest.TestCase):
    ...
    def test_strange_parameters_empty(self):
        ...
        self.assertEquals( len(kb.kb.getData('strange_parameters', 'strange_parameters')) , 0 )
    ...
    def test_strange_parameters_find(self):
        ...
        response = httpResponse(200, body , self.headers, self.url, self.url)
        self.plugin.grep(self.request, response)
        self.assertEquals( len(kb.kb.getData('strange_parameters', 'strange_parameters')) , 1 )
    ...
    def test_multi(self):
        ...
        response = httpResponse(200, body , self.headers, self.url, self.url)
        self.plugin.grep(self.request, response)
        self.assertEquals( len(kb.kb.getData('strange_parameters', 'strange_parameters')) , 2 )
