    ...
    def getOptionsXML(self):
        ...
        <OptionList>\
            <Option name="extensions">\
                <default>'+ ','.join(self._extensions) +'</default>\
                <desc>Extensions that w3af will try to upload</desc>\
                <desc>When finding a form with a file upload, this plugin will try to upload a set of files with the extensions specified here.</desc>\
                <type>list</type>\
            </Option>\
        </OptionList>\
        '
