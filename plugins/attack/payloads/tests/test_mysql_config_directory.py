...
class test_mysql_config_directory(PayloadTestHelper):
    
    EXPECTED_RESULT = {'directory': ['/etc/mysql/']}

    def test_mysql_config_directory(self):
        result = exec_payload(self.shell, 'mysql_config_directory', use_api=True)
