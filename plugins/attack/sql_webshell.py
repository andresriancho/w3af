...
class sql_webshell(AttackPlugin):
    ...
    def _generate_shell(self, vuln_obj):
        '''
        @param vuln_obj: The vuln to exploit, as it was saved in the kb or
    ...
    def _upload_webshell(self, driver, vuln_obj):
        ...
        @param driver: The database driver to use in order to upload the file.
        @param vuln_obj: The vulnerability that we are exploiting.
    ...
    def _upload_file(self, driver, remote_path, content, test_url, test_string):
        ...
        '''
        msg = 'Writing "' + content + '" to "' + remote_path + \
            '" and searching it at: "'
        msg += test_url + '".'
        om.out.debug(msg)
    ...
    def set_options(self, options_list):
        ...
        self._equAlgorithm = options_list['equAlgorithm'].get_value()
